...
?>
		<div id="header" class="cf">
			<div id="top" class="cf">
				<div id="mainLogo">
					<h1 class="fl"><a href="index1.php" tabindex="0" class="showBalloon" title="보건복지부 메인페이지"><img src="../include/images/h1_logo.jpg" width="260" height="70" alt="보건복지부"/><span>보건복지부</span></a></h1>
				</div> <!-- id="mainLogo -->
					...
					<li><a href="../sub02/sub02.php" class="showBalloon" title="민원 페이지" tabindex="2">민원</a>
						<div class="health width100 cf lf">
							<ul class="twoDepth cf">
								...
								<li class="fl">
									<dl>
										<dt><a href="../sub02/sub02.php">안전신문고<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
								<li class="fl">
					...
					<li><a href="../sub04/sub04.php" class="showBalloon" title="정보 페이지" tabindex="4">정보</a>
						<div class="research width100 cf lf">
							<ul class="twoDepth cf">
								...
								<li class="fl">
									<dl>
										<dt><a href="sub04/sub04.php">통상협상<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
								<li class="fl">
									<dl>
										<dt><a href="sub04/sub04.php">주요계획<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
								<li class="fl">
									<dl>
										<dt><a href="sub04/sub04.php">사업<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
								<li class="fl">
					...
					<li><a href="sub05/sub05.php" class="showBalloon" title="알림 페이지" tabindex="5">알림</a>
						<div class="notice width100 cf lf">
							<ul class="twoDepth cf">
								...
								<li class="fl">
									<dl>
										<dt><a href="sub05/sub05.php">입찰안내<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
								<li class="fl">
					...
					<li><a href="sub06/sub06.php" class="showBalloon" title="소개 페이지" tabindex="6">소개</a>
						<div class="stats width100 cf lf">
							<ul class="twoDepth cf">
								...
								<li class="fl">
									<dl>
										<dt><a href="sub06/sub06.php">연혁<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
								<li class="fl">
					...
					<li><a href="../sub07/sub07.php" class="showBalloon" title="정책 페이지" tabindex="7">정책</a>
						<div class="civil width100 cf lf">
							<ul class="twoDepth cf">
								...
								<li class="fl">
									<dl>
										<dt><a href="../sub07/sub07.php">공공보건<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
								<li class="fl">
									<dl>
										<dt><a href="../sub02/sub02.php">한의약<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
								<li class="fl">
								...
								<li class="fl">
									<dl>
										<dt><a href="../sub02/sub02.php">연금<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
							</ul>
					...
					<li><a href="../sub03/sub03.php" title="이용안내 페이지" tabindex="8" class="last showBalloon">이용안내</a>
						<div class="institute width100 cf lf">
							<ul class="twoDepth cf">
								<li class="fl">
									<dl>
										<dt><a href="../sub03/sub03.php">이메일서비스<img src="images/go.png" alt="바로가기"/></a></dt>
								...
								<li class="fl">
									<dl>
										<dt><a href="../sub03/sub03.php">뷰어다운로드<img src="images/go.png" alt="바로가기"/></a></dt>
										<dd></dd>
									</dl>
								</li>
								<li class="fl">
